...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->2-Player", this::twoPlayer);
        addMenuButton("Settings->AI Black", this::autoBlack);
        addMenuButton("Settings->AI White", this::autoWhite);
        addMenuButton("Settings->AI only", this::fullAuto);
        addMenuButton("Settings->Set Move Limit", this::moveLimit);
        addMenuButton("Settings->Set Seed", this::seed);
    ...
    /** Response to an auto white click. */
