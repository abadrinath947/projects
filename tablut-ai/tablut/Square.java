 ...
 *  (upper-right corner). Squares are immutable and unique: there is precisely
 ...
 *  unique Square object for each position, you can freely use the cheap ==
 *  operator (rather than the .equals method) to compare Squares, and the
 *  program does not waste time creating the same square over and over again.
