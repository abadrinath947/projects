...
public class Commit {
    ...
    private String _commitMessage, _identifier, _branch;
    private Set<String> _blobs;
    private Map<String, String> _trackedFiles;

    public Commit(String commitMessage, String branch, Date timestamp, Set<String> blobs) {
    ...
    public String toString() {
        return this._commitMessage + "-" + this._branch + "-" + this._timestamp.getTime() + "-" + getConcatBlobs();
    }
    ...
    public String getBranch() { return this._branch; }
